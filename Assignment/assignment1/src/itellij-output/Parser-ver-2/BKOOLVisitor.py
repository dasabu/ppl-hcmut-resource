...
class BKOOLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKOOLParser#methodTyp.
    def visitMethodTyp(self, ctx:BKOOLParser.MethodTypContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BKOOLParser#construcBody.
    def visitConstrucBody(self, ctx:BKOOLParser.ConstrucBodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKOOLParser#construcMember.
    def visitConstrucMember(self, ctx:BKOOLParser.ConstrucMemberContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BKOOLParser#attrTyp.
    def visitAttrTyp(self, ctx:BKOOLParser.AttrTypContext):
        return self.visitChildren(ctx)
