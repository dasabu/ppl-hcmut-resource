...
class BKOOLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKOOLParser#not_initial.
    def visitNot_initial(self, ctx:BKOOLParser.Not_initialContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKOOLParser#initial.
    def visitInitial(self, ctx:BKOOLParser.InitialContext):
        return self.visitChildren(ctx)
