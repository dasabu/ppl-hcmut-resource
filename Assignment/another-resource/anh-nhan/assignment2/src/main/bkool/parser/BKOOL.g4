...
normalMethod: STATIC? type_name ID LR paramlist? RR block_stmt;
mainMethod: VOID 'main' LR RR block_stmt;
voidMethod: STATIC? VOID ID LR paramlist? RR block_stmt;
constructor: ID LR paramlist? RR block_stmt;



type_name: INT | FLOAT | BOOLEAN | STRING | array_type | class_type;
paramlist: param SEMI paramlist | param;
param: type_name idlist;
...
stmt: var_decl | other_stmt;
var_decl: (FINAL STATIC | STATIC FINAL | STATIC | FINAL |) type_name attribute_list SEMI;

other_stmt: assignment_stmt | if_stmt | for_stmt | break_stmt | continue_stmt | return_stmt | method_invo_stmt | block_stmt;
...
lhs:  scalar_variable | ID indexop;/// scalar ID ID.ID ID.ID[] ID.ID[][]
scalar_variable: ID | exp10_access | exp9 DOT ID  | ID DOT exp9 indexop;
